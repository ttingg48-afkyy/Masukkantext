-- BaraLeaks FIX WINDOW VERSION (Setengah Layar)
-- By ChatGPT for Bara Tampan ❤️
...
local window = new("Frame", {
    Parent = screenGui,
    Name = "Window",
    Size = UDim2.new(0.38, 0, 0.32, 0),
    Position = UDim2.new(0.31, 0, 0.34, 0),
...
local ROWS = {"Info Owner","Coming Soon","Coming Soon","Coming Soon","Coming Soon","Coming Soon"}
local leftWidth = 0.30
...
for i = 1, #ROWS do
    ...
    local left = new("Frame", {
        ...
        Size = UDim2.new(leftWidth,0,1/#ROWS,0),
    ...
    local right = new("Frame", {
        ...
        Size = UDim2.new(1-leftWidth,0,1/#ROWS,0),
    ...
    new("TextLabel", {
        ...
        Text = (i==1) and "Owner" or "Segera Hadir"
    })
...
minBtn.MouseButton1Click:Connect(function()
    if not isMin then
        TweenService:Create(window, TweenInfo.new(.25), {Size = UDim2.new(0,300,0,60)}):Play()
    else
...
local open = false
contentCells[1].InputBegan:Connect(function(i)
    ...
    if open then
        popup.Visible = true
        TweenService:Create(popup, TweenInfo.new(.25),
...
for i = 2, #contentCells do
    contentCells[i].InputBegan:Connect(function(inp)
